...
[![build-ublue](https://github.com/awebeer256/ublue-main/actions/workflows/build.yml/badge.svg)](https://github.com/awebeer256/ublue-main/actions/workflows/build.yml)
...
- Adds the following packages to the base image:
  ...
  - A selection of [udev rules and service units](https://github.com/awebeer256/ublue-config)
  ...
  - Various other tools: check out the [complete list of packages](https://github.com/awebeer256/ublue-main/blob/main/packages.json)
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/awebeer256/ublue-config
...
With that said, you can individually disable which automatic update timers [ublue-os/config](https://github.com/awebeer256/ublue-config) provides with the following commands:
...
## [![Repography logo](https://images.repography.com/logo.svg)](https://repography.com) / Recent activity (for the [original repo](https://github.com/ublue-os/main)) [![Time period](https://images.repography.com/35181738/ublue-os/main/recent-activity/xrA_PaNuNMQaiMXAgCjt1WHFLAbONeWxJABDiQSIMJI/sadhuTBbL8fbqM2jXKHWg-T1EsqHwZ2NlnlT6FB-e7Q_badge.svg)](https://repography.com)
